...
namespace ejercicio3.desafio1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("El resultado de la compuerta logica NAND es: V");
            }
            ...
            {
                Console.WriteLine("El resultado de la compuerta logica NAND es: F");
            }
            ...
            {
                Console.WriteLine("El resultado de la compuerta logica XOR es: F");
            }

            if (entrada1xor == "F" && entrada2xor == "V" || entrada1xor == "f" && entrada2xor == "v" || entrada1xor == "F" && entrada2xor == "v" || entrada1xor == "f" && entrada2xor == "V")
            {
                Console.WriteLine("El resultado de la compuerta logica XOR es: V");
            }
            ...
            Console.WriteLine("\t*                                         *");
            Console.WriteLine("\t*          Erick Magaña                   *");
            Console.WriteLine("\t*                                         *");
            Console.Write("\t");
            Console.WriteLine("*********************************************");
            Console.Write("\t");
